...
(test-multiple :to-rgb
  ...
  (expect-throw (->rgb "#ff00008"))
  (expect-throw (->rgb "#ff00008?"))
  (expect-throw (->rgb "#ff00008"))
  (expect-throw (->rgba "#ff00008?"))
  (expect-throw (->rgba "ff000080"))
  (expect-throw (->rgba "ff0000808"))
  ;; rgb->rgb
...
(test-multiple :to-hsl
  ...
  (expect-throw (->hsl "#ff00008?"))
  (expect-throw (->hsl "#ff00008"))
  (expect-throw (->hsla "#ff00008?"))
  (expect-throw (->hsla "ff000080"))
  (expect-throw (->hsla "ff0000808"))
  ;; hsl->hsl
